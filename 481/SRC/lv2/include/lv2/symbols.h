...
#elif defined(FIRMWARE_4_80) // Porting by Alexander whit GetSymbol

#define TOC							0x34FBA0 // Alexander - IDA ok

#define create_kernel_object_symbol			0x11FAC // Alexander - IDA ok
#define destroy_kernel_object_symbol			0x11910 // Alexander - IDA ok
#define destroy_shared_kernel_object_symbol		0x11284 // Alexander - IDA ok
#define open_kernel_object_symbol			0x125FC // Alexander - IDA ok
#define open_shared_kernel_object_symbol		0x1240C // Alexander - IDA ok
#define close_kernel_object_handle_symbol		0x11A2C // Alexander - IDA ok

#define alloc_symbol					0x64820 // Alexander - IDA ok
#define dealloc_symbol					0x64C5C // Alexander - IDA ok
#define copy_to_user_symbol				0xF868 // Alexander - IDA ok
#define copy_from_user_symbol				0xFA84 // Alexander - IDA ok
#define copy_to_process_symbol				0xF920 // Alexander - IDA ok
#define copy_from_process_symbol			0xF730 // Alexander - IDA ok
#define page_allocate_symbol				0x60390 // Alexander - IDA ok
#define page_free_symbol				0x5FDF4 // Alexander - IDA ok
#define page_export_to_proc_symbol			0x6052C // Alexander - IDA ok
#define page_unexport_from_proc_symbol		        0x5FCE8 // Alexander - IDA ok
#define kernel_ea_to_lpar_addr_symbol			0x70148 // Alexander - IDA ok
#define process_ea_to_lpar_addr_ex_symbol		0x7775C // Alexander - IDA ok
#define set_pte_symbol                                  0x5E38C // Alexander - IDA ok
#define map_process_memory_symbol			0x77268 // Alexander - IDA ok
#define panic_symbol					0x26D5BC // Alexander - IDA ok 

#define memcpy_symbol					0x7E928 // Alexander - IDA ok
#define memset_symbol					0x4D668 // Alexander - IDA ok
#define memcmp_symbol					0x4C978 // Alexander - IDA ok
#define memchr_symbol					0x4C928 // Alexander - IDA ok
#define printf_symbol					0x2706A0 // Alexander - IDA ok 
#define printfnull_symbol				0x275114 // Alexander - IDA ok 
#define sprintf_symbol					0x4EA90 // Alexander - IDA ok
#define snprintf_symbol					0x4E9FC // Alexander - IDA ok
#define strcpy_symbol					0x4D814 // Alexander - IDA ok
#define strncpy_symbol					0x4D8DC // Alexander - IDA ok
#define strlen_symbol					0x4D83C // Alexander - IDA ok
#define strcat_symbol					0x4D744 // Alexander - IDA ok
#define strcmp_symbol					0x4D7C0 // Alexander - IDA ok
#define strncmp_symbol					0x4D868 // Alexander - IDA ok
#define strchr_symbol					0x4D77C // Alexander - IDA ok
#define strrchr_symbol					0x4D94C // Alexander - IDA ok

#define spin_lock_irqsave_ex_symbol			0x26D78C // Alexander - IDA ok  
#define spin_unlock_irqrestore_ex_symbol		0x26D760 // Alexander - IDA ok 

#define create_process_common_symbol			0x26B528 // Alexander - IDA ok 
#define create_process_base_symbol			0x26ABE4 // Alexander - IDA ok  
#define load_process_symbol				0x5004 // Alexander - IDA ok
#define process_kill_symbol				0x26B334 // Alexander - IDA ok  

#define ppu_thread_create_symbol			0x13EC4 // Alexander - IDA ok
#define ppu_thread_exit_symbol				0x13F7C // Alexander - IDA ok
#define ppu_thread_join_symbol				0x13FD0 // Alexander - IDA ok
#define ppu_thread_delay_symbol				0x287A0 // Alexander - IDA ok
#define create_kernel_thread_symbol			0x24B1C // Alexander - IDA ok
#define create_user_thread_symbol			0x25258 // Alexander - IDA ok
#define create_user_thread2_symbol			0x2507C // Alexander - IDA ok
#define start_thread_symbol				0x23D48 // Alexander - IDA ok
#define run_thread_symbol				0x23578 // Alexander - IDA ok
#define register_thread_symbol				0x267940 // Alexander - IDA ok 
#define allocate_user_stack_symbol			0x268128 // Alexander - IDA ok 
#define deallocate_user_stack_symbol			0x268090 // Alexander - IDA ok 

#define mutex_create_symbol				0x13638 // Alexander - IDA ok
#define mutex_destroy_symbol				0x135D0 // Alexander - IDA ok
#define mutex_lock_symbol				0x135C8 // Alexander - IDA ok
#define mutex_lock_ex_symbol				0x1DB58 // Alexander - IDA ok
#define mutex_trylock_symbol				0x135C4 // Alexander - IDA ok
#define mutex_unlock_symbol				0x135C0 // Alexander - IDA ok

#define cond_create_symbol				0x137A4 // Alexander - IDA ok
#define cond_destroy_symbol				0x13754 // Alexander - IDA ok
#define cond_wait_symbol				0x1374C // Alexander - IDA ok
#define cond_wait_ex_symbol				0x1F144 // Alexander - IDA ok
#define cond_signal_symbol				0x13728 // Alexander - IDA ok
#define cond_signal_all_symbol				0x13704 // Alexander - IDA ok

#define semaphore_initialize_symbol			0x30C50 // Alexander - IDA ok
#define semaphore_wait_ex_symbol			0x30958 // Alexander - IDA ok
#define semaphore_trywait_symbol			0x30540 // Alexander - IDA ok
#define semaphore_post_ex_symbol			0x3068C // Alexander - IDA ok

#define event_port_create_symbol			0x13074 // Alexander - IDA ok
#define event_port_destroy_symbol			0x134DC // Alexander - IDA ok
#define event_port_connect_symbol			0x13554 // Alexander - IDA ok
#define event_port_disconnect_symbol			0x13480 // Alexander - IDA ok
#define event_port_send_symbol				0x1306C // Alexander - IDA ok
#define event_port_send_ex_symbol			0x2B200 // Alexander - IDA ok

#define event_queue_create_symbol			0x1337C // Alexander - IDA ok
#define event_queue_destroy_symbol			0x13304 // Alexander - IDA ok
#define event_queue_receive_symbol			0x13148 // Alexander - IDA ok
#define event_queue_tryreceive_symbol			0x13214 // Alexander - IDA ok

#define cellFsOpen_symbol				0x2978F4 // Alexander - IDA ok 
#define cellFsClose_symbol				0x29775C // Alexander - IDA ok 
#define cellFsRead_symbol				0x297898 // Alexander - IDA ok 
#define cellFsWrite_symbol				0x297804 // Alexander - IDA ok 
#define cellFsLseek_symbol				0x296E8C // Alexander - IDA ok 
#define cellFsStat_symbol				0x297110 // Alexander - IDA ok 
#define cellFsUtime_symbol 				0x298BFC // Alexander - IDA ok 
#define cellFsUnlink_internal_symbol			0x19C644 // Alexander - IDA okConfrimed

#define cellFsUtilMount_symbol				0x296C6C // Alexander - IDA ok 
#define cellFsUtilUmount_symbol 			0x296C40 // Alexander - IDA ok 
#define cellFsUtilNewfs_symbol				0x298694 // Alexander - IDA ok 

#define pathdup_from_user_symbol			0x29C8D8 // Alexander - IDA ok 
#define	open_path_symbol				0x29762C  // Alexander - IDA ok 
#define open_fs_object_symbol				0x18A968 // Alexander - IDA ok 
#define close_fs_object_symbol				0x1898A4 // Alexander - IDA ok 

#define storage_get_device_info_symbol			0x279AF4 // Alexander - IDA ok 
#define storage_get_device_config_symbol		0x278F84 // Alexander - IDA okdone
#define storage_open_symbol				0x279504 // Alexander - IDA okDone
#define storage_close_symbol				0x2792F4 // Alexander - IDA okDone
#define storage_read_symbol				0x278864 // Alexander - IDA okDone
#define storage_write_symbol				0x278734 // Alexander - IDA okDone
#define storage_send_device_command_symbol		0x2783F0 // Alexander - IDA okDone
#define storage_map_io_memory_symbol			0x2799B0 // Alexander - IDA okDone
#define storage_unmap_io_memory_symbol		        0x27987C // Alexander - IDA okDone
#define new_medium_listener_object_symbol		0x974BC // Alexander - IDA ok
#define delete_medium_listener_object_symbol		0x98CF4 // Alexander - IDA ok
#define set_medium_event_callbacks_symbol		0x99058 // Alexander - IDA ok

#define cellUsbdRegisterLdd_symbol			0x260274 // Alexander - IDA okDone
#define cellUsbdUnregisterLdd_symbol			0x260224 // Alexander - IDA okDone
#define cellUsbdScanStaticDescriptor_symbol		0x261474 // Alexander - IDA okDone
#define cellUsbdOpenPipe_symbol			        0x261524 // Alexander - IDA okDone
#define cellUsbdClosePipe_symbol			0x2614D4 // Alexander - IDA okDone
#define cellUsbdControlTransfer_symbol			0x2613D8 // Alexander - IDA okDone
#define cellUsbdBulkTransfer_symbol			0X261358 // Alexander - IDA okDone

#define decrypt_func_symbol				0x3496C // Alexander - IDA ok
#define lv1_call_99_wrapper_symbol			0x4EEA4 // Alexander - IDA ok
#define modules_verification_symbol			0x58AB4 // Alexander - IDA ok
#define authenticate_program_segment_symbol		0x5A90C // Alexander - IDA ok

#define prx_load_module_symbol				0x88C00 // Alexander - IDA ok
#define prx_start_module_symbol				0x878CC // Alexander - IDA ok
#define prx_stop_module_symbol				0x88CA4 // Alexander - IDA ok
#define prx_unload_module_symbol			0x87600 // Alexander - IDA ok
#define prx_get_module_info_symbol			0x87088 // Alexander - IDA ok
#define prx_get_module_id_by_address_symbol		0x86F98 // Alexander - IDA ok
#define prx_get_module_id_by_name_symbol		0x86FE8 // Alexander - IDA ok
#define prx_get_module_list_symbol			0x87108 // Alexander - IDA ok
#define load_module_by_fd_symbol			0x88230 // Alexander - IDA ok
#define parse_sprx_symbol				0x85FB4 // Alexander - IDA ok
#define open_prx_object_symbol				0x7F4F4 // Alexander - IDA ok
#define close_prx_object_symbol				0x7FE04 // Alexander - IDA ok
#define lock_prx_mutex_symbol				0x86F40 // Alexander - IDA ok
#define unlock_prx_mutex_symbol				0x86F4C // Alexander - IDA ok

#define extend_kstack_symbol				0x700A0 // Alexander - IDA ok

#define get_pseudo_random_number_symbol		0x228178 // Alexander - IDA ok
#define md5_reset_symbol					0x161E18 // Alexander - IDA ok
#define md5_update_symbol				0x1628B8 // Alexander - IDA ok
#define md5_final_symbol					0x162A38 // Alexander - IDA ok
#define ss_get_open_psid_symbol				0x22A660 // Alexander - IDA ok
#define update_mgr_read_eeprom_symbol		0x223A70 // Alexander - IDA ok
#define update_mgr_write_eeprom_symbol		0x2239B8 // Alexander - IDA ok

#define ss_params_get_update_status_symbol		0x50AB0 // Alexander - IDA ok

#define syscall_table_symbol				0x363BE0 // Alexander - IDA okdone
#define syscall_call_offset					0x275BF8 // Alexander - IDA ok

#define read_bdvd0_symbol				0x1A4614 // Alexander - IDA ok
#define read_bdvd1_symbol				0x1A6240 // Alexander - IDA ok
#define read_bdvd2_symbol				0x1B33F8 // Alexander - IDA ok

#define storage_internal_get_device_object_symbol	0x277EA8 // Alexander - IDA ok

#define hid_mgr_read_usb_symbol			0x10243C // Alexander - IDA ok
#define hid_mgr_read_bt_symbol				0xFC314 // Alexander - IDA ok

#define bt_set_controller_info_internal_symbol		0xF0380 // Alexander - IDA ok

/* Calls, jumps */
#define device_event_port_send_call			0x282060 // Alexander - IDA ok

#define ss_pid_call_1					0x213294 // Alexander - IDA ok

#define process_map_caller_call				0x4D24 // Alexander - IDA ok

#define read_module_header_call				0x7F3E8 // Alexander - IDA ok
#define read_module_body_call				0x671C // Alexander - IDA ok
#define load_module_by_fd_call1				0x88A9C // Alexander - IDA ok

#define shutdown_copy_params_call			0xAACC // Alexander - IDA ok

#define fsloop_open_call					0x297A8C // Alexander - IDA ok
#define fsloop_close_call					0x297ADC // Alexander - IDA ok
#define fsloop_read_call					0x297B1C // Alexander - IDA ok

/* Patches */
#define shutdown_patch_offset				0xAAB8 // Alexander - IDA ok
#define module_sdk_version_patch_offset		0x267170 // Alexander - IDA ok
#define module_add_parameter_to_parse_sprxpatch_offset	0x8830C // Alexander - IDA ok

#define user_thread_prio_patch				0x203F8 // Alexander - IDA ok
#define user_thread_prio_patch2				0x20404 // Alexander - IDA ok

#define lic_patch						0x5622C // Alexander - IDA ok
#define ode_patch						0x2275EC // Alexander - IDA ok

/* Rtoc entries */

#define io_rtoc_entry_1					0x25B8 // Alexander - IDA ok
#define io_sub_rtoc_entry_1				-0x7EA0 // Alexander - IDA ok
#define decrypt_rtoc_entry_2 				-0x66A0 // Alexander - IDA ok
#define decrypter_data_entry				-0x7F10  // Alexander - IDA ok

#define storage_rtoc_entry_1				0x1DD8 // Alexander - IDA ok

#define device_event_rtoc_entry_1			0x2048 // Alexander - IDA ok

#define time_rtoc_entry_1					-0x7640 // Alexander - IDA ok
#define time_rtoc_entry_2					-0x7648 // Alexander - IDA ok

#define thread_rtoc_entry_1				-0x76C0 // Alexander - IDA ok

#define process_rtoc_entry_1				-0x7800 // Alexander - IDA ok

#define bt_rtoc_entry_1					-0x3680 // Alexander - IDA ok

/* Permissions */
#define permissions_func_symbol				0x3560 // Alexander - IDA ok
#define permissions_exception1 				0x250FC // Alexander - IDA ok
#define permissions_exception2				0xC3290 // Alexander - IDA ok
#define permissions_exception3				0x204CC // Alexander - IDA ok

/* Legacy patches with no names yet */
/* Kernel offsets */
#define patch_data1_offset				0x3E0DC0 // Alexander - IDA ok
#define patch_func2 					0x59D80 // Alexander - IDA ok
#define patch_func2_offset 				0x2C 
#define patch_func8 					0x56408 // Alexander - IDA ok
#define patch_func8_offset1 				0xA4 // Alexander - IDA ok
#define patch_func8_offset2 				0x208 // Alexander - IDA ok
#define patch_func9 					0x5A23C // Alexander - IDA ok
#define patch_func9_offset 				0x4B8 // Alexander - IDA ok
#define mem_base2					0x3D90 // Alexander - IDA ok

/* vars */
#define thread_info_symbol				0x37DE3 // ok!!

#elif defined(FIRMWARE_4_81) // Porting by Alexander whit GetSymbol

#define TOC							0x34FBB0 //done

#define create_kernel_object_symbol			0x11FB0 // Alexander - IDA ok
#define destroy_kernel_object_symbol			0x11914 // Alexander - IDA ok
#define destroy_shared_kernel_object_symbol		0x11288 // Alexander - IDA ok
#define open_kernel_object_symbol			0x12600 // Alexander - IDA ok
#define open_shared_kernel_object_symbol		0x12410 // Alexander - IDA ok
#define close_kernel_object_handle_symbol		0x11A30 // Alexander - IDA ok

#define alloc_symbol					0x64824 // Alexander - IDA ok
#define dealloc_symbol					0x64C60 // Alexander - IDA ok
#define copy_to_user_symbol				0xF86C // Alexander - IDA ok
#define copy_from_user_symbol				0xFA88 // Alexander - IDA ok
#define copy_to_process_symbol				0xF924 // Alexander - IDA ok
#define copy_from_process_symbol			0xF734 // Alexander - IDA ok
#define page_allocate_symbol				0x60394 // Alexander - IDA ok
#define page_free_symbol				0x5FDF8 // Alexander - IDA ok
#define page_export_to_proc_symbol			0x60530 // Alexander - IDA ok
#define page_unexport_from_proc_symbol		        0x5FCEC // Alexander - IDA ok
#define kernel_ea_to_lpar_addr_symbol			0x7014C // Alexander - IDA ok
#define process_ea_to_lpar_addr_ex_symbol		0x77760 // Alexander - IDA ok
#define set_pte_symbol                                  0x5E390 // Alexander - IDA ok
#define map_process_memory_symbol			0x7726C // Alexander - IDA ok
#define panic_symbol					0x26D5C8 // Alexander - IDA ok

#define memcpy_symbol					0x7E92C // Alexander - IDA ok
#define memset_symbol					0x4D66C // Alexander - IDA ok
#define memcmp_symbol					0x4C97C // Alexander - IDA ok
#define memchr_symbol					0x4C92C // Alexander - IDA ok
#define printf_symbol					0x2706AC // Alexander - IDA ok
#define printfnull_symbol				0x275120 // Alexander - IDA ok
#define sprintf_symbol					0x4EA94 // Alexander - IDA ok
#define snprintf_symbol					0x4EA00 // Alexander - IDA ok
#define strcpy_symbol					0x4D818 // Alexander - IDA ok
#define strncpy_symbol					0x4D8E0 // Alexander - IDA ok
#define strlen_symbol					0x4D840 // Alexander - IDA ok
#define strcat_symbol					0x4D748 // Alexander - IDA ok
#define strcmp_symbol					0x4D7C4 // Alexander - IDA ok
#define strncmp_symbol					0x4D86C // Alexander - IDA ok
#define strchr_symbol					0x4D780 // Alexander - IDA ok
#define strrchr_symbol					0x4D950 // Alexander - IDA ok

#define spin_lock_irqsave_ex_symbol			0x26D798 // Alexander - IDA ok
#define spin_unlock_irqrestore_ex_symbol		0x26D76C // Alexander - IDA ok

#define create_process_common_symbol			0x26B534 // Alexander - IDA ok
#define create_process_base_symbol			0x26ABF0 // Alexander - IDA ok
#define load_process_symbol				0x5004 // Alexander - IDA ok
#define process_kill_symbol				0x26B340 // Alexander - IDA ok

#define ppu_thread_create_symbol			0x13EC8 // Alexander - IDA ok
#define ppu_thread_exit_symbol				0x13F80 // Alexander - IDA ok
#define ppu_thread_join_symbol				0x13FD4 // Alexander - IDA ok
#define ppu_thread_delay_symbol				0x287A4 // Alexander - IDA ok
#define create_kernel_thread_symbol			0x24B20 // Alexander - IDA ok
#define create_user_thread_symbol			0x2525C // Alexander - IDA ok
#define create_user_thread2_symbol			0x25080 // Alexander - IDA ok
#define start_thread_symbol				0x23D4C // Alexander - IDA ok
#define run_thread_symbol				0x2357C // Alexander - IDA ok
#define register_thread_symbol				0x26794C // Alexander - IDA ok
#define allocate_user_stack_symbol			0x268134 // Alexander - IDA ok
#define deallocate_user_stack_symbol			0x26809C // Alexander - IDA ok

#define mutex_create_symbol				0x1363C // Alexander - IDA ok
#define mutex_destroy_symbol				0x135D4 // Alexander - IDA ok
#define mutex_lock_symbol				0x135CC // Alexander - IDA ok
#define mutex_lock_ex_symbol				0x1DB5C // Alexander - IDA ok
#define mutex_trylock_symbol				0x135C8 // Alexander - IDA ok
#define mutex_unlock_symbol				0x135C4 // Alexander - IDA ok

#define cond_create_symbol				0x137A8 // Alexander - IDA ok
#define cond_destroy_symbol				0x13758 // Alexander - IDA ok
#define cond_wait_symbol				0x13750 // Alexander - IDA ok
#define cond_wait_ex_symbol				0x1F148 // Alexander - IDA ok
#define cond_signal_symbol				0x1372C // Alexander - IDA ok
#define cond_signal_all_symbol				0x13708 // Alexander - IDA ok

#define semaphore_initialize_symbol			0x30C54 // Alexander - IDA ok
#define semaphore_wait_ex_symbol			0x3095C // Alexander - IDA ok
#define semaphore_trywait_symbol			0x30544 // Alexander - IDA ok
#define semaphore_post_ex_symbol			0x30690 // Alexander - IDA ok

#define event_port_create_symbol			0x13078 // Alexander - IDA ok
#define event_port_destroy_symbol			0x134E0 // Alexander - IDA ok
#define event_port_connect_symbol			0x13558 // Alexander - IDA ok
#define event_port_disconnect_symbol			0x13484 // Alexander - IDA ok
#define event_port_send_symbol				0x13070 // Alexander - IDA ok
#define event_port_send_ex_symbol			0x2B204 // Alexander - IDA ok

#define event_queue_create_symbol			0x13380 // Alexander - IDA ok
#define event_queue_destroy_symbol			0x13308 // Alexander - IDA ok
#define event_queue_receive_symbol			0x1314C // Alexander - IDA ok
#define event_queue_tryreceive_symbol			0x13218 // Alexander - IDA ok

#define cellFsOpen_symbol				0x297900 // Alexander - IDA ok
#define cellFsClose_symbol				0x297768 // Alexander - IDA ok
#define cellFsRead_symbol				0x2978A4 // Alexander - IDA ok
...
#define cellFsUtilUmount_symbol 			0x296C4C // aldostools - ok
#define cellFsUtilNewfs_symbol				0x2986A0 // Alexander - IDA ok

#define pathdup_from_user_symbol			0x29C8E4 // Alexander - IDA ok
#define	open_path_symbol				0x297638  // aldostools - ok
#define open_fs_object_symbol				0x18A970 // Alexander - IDA ok
#define close_fs_object_symbol				0x1898AC // Alexander - IDA ok

#define storage_get_device_info_symbol			0x279B00 // Alexander - IDA ok
#define storage_get_device_config_symbol		0x278F90 // Alexander - IDA ok
#define storage_open_symbol				0x279510 // Alexander - IDA ok
#define storage_close_symbol				0x279300 // Alexander - IDA ok
#define storage_read_symbol				0x278870 // Alexander - IDA ok
#define storage_write_symbol				0x278740 // Alexander - IDA ok
#define storage_send_device_command_symbol		0x2783FC // Alexander - IDA ok
#define storage_map_io_memory_symbol			0x2799BC // Alexander - IDA ok
#define storage_unmap_io_memory_symbol		        0x279888 // Alexander - IDA ok
#define new_medium_listener_object_symbol		0x974C4 // Alexander - IDA ok
#define delete_medium_listener_object_symbol		0x98CFC // Alexander - IDA ok
#define set_medium_event_callbacks_symbol		0x99060 // Alexander - IDA ok

#define cellUsbdRegisterLdd_symbol			0x26027C // Alexander - IDA ok
#define cellUsbdUnregisterLdd_symbol			0x26022C // Alexander - IDA ok
#define cellUsbdScanStaticDescriptor_symbol		0x26147C // Alexander - IDA ok
...
#define modules_verification_symbol			0x58AB8 // Alexander - IDA ok
#define authenticate_program_segment_symbol		0x5A910 // Alexander - IDA ok

#define prx_load_module_symbol				0x88C04 // Alexander - IDA ok
#define prx_start_module_symbol				0x878D0 // Alexander - IDA ok
#define prx_stop_module_symbol				0x88CA8 // Alexander - IDA ok
#define prx_unload_module_symbol			0x87604 // Alexander - IDA ok
#define prx_get_module_info_symbol			0x8708C // Alexander - IDA ok
#define prx_get_module_id_by_address_symbol		0x86F9C // Alexander - IDA ok
#define prx_get_module_id_by_name_symbol		0x86FEC // Alexander - IDA ok
#define prx_get_module_list_symbol			0x8710C // Alexander - IDA ok
#define load_module_by_fd_symbol			0x88234 // Alexander - IDA ok
#define parse_sprx_symbol				0x85FB8 // Alexander - IDA ok
#define open_prx_object_symbol				0x7F4F8 // Alexander - IDA ok
#define close_prx_object_symbol				0x7FE08 // Alexander - IDA ok
#define lock_prx_mutex_symbol				0x86F44 // Alexander - IDA ok
#define unlock_prx_mutex_symbol				0x86F50 // Alexander - IDA ok

#define extend_kstack_symbol				0x700A4 // Alexander - IDA ok

#define get_pseudo_random_number_symbol		0x228180 // Alexander - IDA ok
#define md5_reset_symbol					0x161E20 // Alexander - IDA ok
#define md5_update_symbol				0x1628C0 // Alexander - IDA ok
#define md5_final_symbol					0x162A40 // Alexander - IDA ok
#define ss_get_open_psid_symbol				0x22A668 // Alexander - IDA ok
#define update_mgr_read_eeprom_symbol		0x223A78 // Alexander - IDA ok
#define update_mgr_write_eeprom_symbol		0x2239C0 // Alexander - IDA ok

#define ss_params_get_update_status_symbol		0x50AB4 // Alexander - IDA ok

#define syscall_table_symbol				0x363BE0 // Alexander - IDA ok
#define syscall_call_offset					0x275C04 // Alexander - IDA ok

#define read_bdvd0_symbol				0x1A461C // Alexander - IDA ok
#define read_bdvd1_symbol				0x1A6248 // Alexander - IDA ok
#define read_bdvd2_symbol				0x1B3400 // Alexander - IDA ok

#define storage_internal_get_device_object_symbol	0x277EB4 // Alexander - IDA ok

#define hid_mgr_read_usb_symbol			0x102444 // Alexander - IDA ok
#define hid_mgr_read_bt_symbol				0xFC31C // Alexander - IDA ok

#define bt_set_controller_info_internal_symbol		0xF0388 // Alexander - IDA ok

/* Calls, jumps */
#define device_event_port_send_call			0x28206C // Alexander - IDA ok

#define ss_pid_call_1					0x21329C // Alexander - IDA ok

#define process_map_caller_call				0x4D24 // Alexander - IDA ok

#define read_module_header_call				0x7F3EC // Alexander - IDA ok
#define read_module_body_call				0x671C // Alexander - IDA ok
#define load_module_by_fd_call1				0x88AA0 // Alexander - IDA ok

#define shutdown_copy_params_call			0xAACC // Alexander - IDA ok

#define fsloop_open_call					0x297A98 // Alexander - IDA ok
#define fsloop_close_call					0x297AE8 // Alexander - IDA ok
#define fsloop_read_call					0x297B28 // Alexander - IDA ok

/* Patches */
#define shutdown_patch_offset				0xAAB8 // Alexander - IDA ok
#define module_sdk_version_patch_offset		0x26717C // Alexander - IDA ok
#define module_add_parameter_to_parse_sprxpatch_offset	0x88310 // Alexander - IDA ok

#define user_thread_prio_patch				0x203FC // Alexander - IDA ok
#define user_thread_prio_patch2				0x20408 // Alexander - IDA ok

#define lic_patch						0x56230 // Alexander - IDA ok
#define ode_patch						0x2275F4 // Alexander - IDA ok
...
#define io_sub_rtoc_entry_1				-0x7EA0 // Alexander - IDA ok
#define decrypt_rtoc_entry_2 				-0x66A0 // Alexander - IDA ok
#define decrypter_data_entry				-0x7F10  // Alexander - IDA ok //UNTOUCHED
...
/* Permissions */
#define permissions_func_symbol				0x3560 // Alexander - IDA ok
#define permissions_exception1 				0x25100 // Alexander - IDA ok
#define permissions_exception2				0xC3298 // Alexander - IDA ok
#define permissions_exception3				0x204D0 // Alexander - IDA ok
...
#define patch_func8_offset1 				0xA4 // Alexander - IDA ok
#define patch_func8_offset2 				0x208 // Alexander - IDA ok
#define patch_func9 					0x5A240 // Alexander - IDA ok
#define patch_func9_offset 				0x4B8 // Alexander - IDA ok
#define mem_base2					0x3D90 // Alexander - IDA ok
