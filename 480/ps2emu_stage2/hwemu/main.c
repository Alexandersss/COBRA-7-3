...
#elif defined(FIRMWARE_4_76) || defined(FIRMWARE_4_78) || defined(FIRMWARE_4_80) // the same as 4.65
...
#if defined(FIRMWARE_3_41) || defined(FIRMWARE_3_55) || defined(FIRMWARE_4_30) || defined(FIRMWARE_4_76) || defined(FIRMWARE_4_78) || defined(FIRMWARE_4_80)
