...
#define create_kernel_object_symbol			0x11FB0 // IDA ok! 
#define destroy_kernel_object_symbol			0x11914 // IDA ok! 
#define destroy_shared_kernel_object_symbol		0x11288 // IDA ok! 
#define open_kernel_object_symbol			0x12600 // IDA ok! 
#define open_shared_kernel_object_symbol		0x12410 // IDA ok! 
#define close_kernel_object_handle_symbol		0x11A30 // IDA ok! 

#define alloc_symbol					0x64824 // IDA ok! 
#define dealloc_symbol					0x64C60 // IDA ok! 
#define copy_to_user_symbol				0xF86C // IDA ok! 
#define copy_from_user_symbol				0xFA88 // IDA ok! 
#define copy_to_process_symbol				0xF924 // IDA ok! 
#define copy_from_process_symbol			0xF734 // IDA ok! 
#define page_allocate_symbol				0x60394 // IDA ok! 
#define page_free_symbol				0x5FDF8 // IDA ok! 
#define page_export_to_proc_symbol			0x60530 // IDA ok! 
#define page_unexport_from_proc_symbol		        0x5FCEC // IDA ok! 
#define kernel_ea_to_lpar_addr_symbol			0x7014C // IDA ok! 
#define process_ea_to_lpar_addr_ex_symbol		0x77760 // IDA ok! 
#define set_pte_symbol                                  0x5E390 // IDA ok! 
#define map_process_memory_symbol			0x7726C // IDA ok! 
#define panic_symbol					0x26D5C8 // IDA ok! 

#define memcpy_symbol					0x7E92C // IDA ok! 
#define memset_symbol					0x4D66C // IDA ok! 
#define memcmp_symbol					0x4C97C // IDA ok! 
#define memchr_symbol					0x4C92C // IDA ok! 
#define printf_symbol					0x2706AC // IDA ok! 
#define printfnull_symbol				0x275120 // IDA ok! 
#define sprintf_symbol					0x4EA94 // IDA ok! 
#define snprintf_symbol					0x4EA00 // IDA ok! 
#define strcpy_symbol					0x4D818 // IDA ok! 
#define strncpy_symbol					0x4D8E0 // IDA ok! 
#define strlen_symbol					0x4D840 // IDA ok! 
#define strcat_symbol					0x4D748 // IDA ok! 
#define strcmp_symbol					0x4D7C4 // IDA ok! 
#define strncmp_symbol					0x4D86C // IDA ok! 
#define strchr_symbol					0x4D780 // IDA ok! 
#define strrchr_symbol					0x4D950 // IDA ok! 

#define spin_lock_irqsave_ex_symbol			0x26D798 // IDA ok! 
#define spin_unlock_irqrestore_ex_symbol		0x26D76C // IDA ok! 

#define create_process_common_symbol			0x26B534 // IDA ok! 
#define create_process_base_symbol			0x26ABF0 // IDA ok! 
#define load_process_symbol				0x5004 // IDA ok! 
#define process_kill_symbol				0x26B340 // IDA ok! 

#define ppu_thread_create_symbol			0x13EC8 // IDA ok! 
#define ppu_thread_exit_symbol				0x13F80 // IDA ok! 
#define ppu_thread_join_symbol				0x13FD4 // IDA ok! 
#define ppu_thread_delay_symbol				0x287A4 // IDA ok! 
#define create_kernel_thread_symbol			0x24B20 // IDA ok! 
#define create_user_thread_symbol			0x2525C // IDA ok! 
#define create_user_thread2_symbol			0x25080 // IDA ok! 
#define start_thread_symbol				0x23D4C // IDA ok! 
#define run_thread_symbol				0x2357C // IDA ok! 
#define register_thread_symbol				0x26794C // IDA ok! 
#define allocate_user_stack_symbol			0x268134 // IDA ok! 
#define deallocate_user_stack_symbol			0x26809C // IDA ok! 

#define mutex_create_symbol				0x1363C // IDA ok! 
#define mutex_destroy_symbol				0x135D4 // IDA ok! 
#define mutex_lock_symbol				0x135CC // IDA ok! 
#define mutex_lock_ex_symbol				0x1DB5C // IDA ok! 
#define mutex_trylock_symbol				0x135C8 // IDA ok! 
#define mutex_unlock_symbol				0x135C4 // IDA ok! 

#define cond_create_symbol				0x137A8 // IDA ok! 
#define cond_destroy_symbol				0x13758 // IDA ok! 
#define cond_wait_symbol				0x13750 // IDA ok! 
#define cond_wait_ex_symbol				0x1F148 // IDA ok! 
#define cond_signal_symbol				0x1372C // IDA ok! 
#define cond_signal_all_symbol				0x13708 // IDA ok! 

#define semaphore_initialize_symbol			0x30C54 // IDA ok! 
#define semaphore_wait_ex_symbol			0x3095C // IDA ok! 
#define semaphore_trywait_symbol			0x30544 // IDA ok! 
#define semaphore_post_ex_symbol			0x30690 // IDA ok! 

#define event_port_create_symbol			0x13078 // IDA ok! 
#define event_port_destroy_symbol			0x134E0 // IDA ok! 
#define event_port_connect_symbol			0x13558 // IDA ok! 
#define event_port_disconnect_symbol			0x13484 // IDA ok! 
#define event_port_send_symbol				0x13070 // IDA ok! 
#define event_port_send_ex_symbol			0x2B204 // IDA ok! 

#define event_queue_create_symbol			0x13380 // IDA ok! 
#define event_queue_destroy_symbol			0x13308 // IDA ok! 
#define event_queue_receive_symbol			0x1314C // IDA ok! 
#define event_queue_tryreceive_symbol			0x13218 // IDA ok! 

#define cellFsOpen_symbol				0x297900 // IDA ok! 
#define cellFsClose_symbol				0x297768 // IDA ok! 
#define cellFsRead_symbol				0x2978A4 // IDA ok! 
#define cellFsWrite_symbol				0x297810 // IDA ok! 
#define cellFsLseek_symbol				0x296E98 // IDA ok! 
#define cellFsStat_symbol				0x29711C // IDA ok! 
#define cellFsUtime_symbol 				0x298C08 // IDA ok! 
#define cellFsUnlink_internal_symbol			0x19C64C // IDA ok! 

#define cellFsUtilMount_symbol				0x296C78 // IDA ok! 
#define cellFsUtilUmount_symbol 			0x296C4C // IDA ok! 
#define cellFsUtilNewfs_symbol				0x2986A0 // IDA ok! 

#define pathdup_from_user_symbol			0x29C8E4 // IDA ok! 
#define	open_path_symbol				0x297638 // IDA ok! 
#define open_fs_object_symbol				0x18A970 //  IDA ok! 
#define close_fs_object_symbol				0x1898AC // IDA ok! 

#define storage_get_device_info_symbol			0x279B00 // IDA ok! 
#define storage_get_device_config_symbol		0x278F90 // IDA ok! 
#define storage_open_symbol				0x279510 //IDA ok! 
#define storage_close_symbol				0x279300 // IDA ok! 
#define storage_read_symbol				0x278870 //IDA ok! 
#define storage_write_symbol				0x278740 // IDA ok! 
#define storage_send_device_command_symbol		0x2783FC // IDA ok! 
#define storage_map_io_memory_symbol			0x2799BC // IDA ok! 
#define storage_unmap_io_memory_symbol		        0x279888 // IDA ok! 
#define new_medium_listener_object_symbol		0x974C4 // IDA ok! 
#define delete_medium_listener_object_symbol		0x98CFC // IDA ok! 
#define set_medium_event_callbacks_symbol		0x99060 // IDA ok! 

#define cellUsbdRegisterLdd_symbol			0x26027C // IDA ok! 
#define cellUsbdUnregisterLdd_symbol			0x26022C // IDA ok! 
#define cellUsbdScanStaticDescriptor_symbol		0x26147C // IDA ok! 
#define cellUsbdOpenPipe_symbol			        0x26152C // IDA ok! 
#define cellUsbdClosePipe_symbol			0x2614DC // IDA ok! 
#define cellUsbdControlTransfer_symbol			0x2613E0 // IDA ok! 
#define cellUsbdBulkTransfer_symbol			0x261360 // IDA ok! 

#define decrypt_func_symbol				0x34970 // IDA ok! 
#define lv1_call_99_wrapper_symbol			0x4EEA8 // IDA ok! 
#define modules_verification_symbol			0x58AB8 // IDA ok! 
#define authenticate_program_segment_symbol		0x5A910 // IDA ok! 

#define prx_load_module_symbol				0x88C04 // IDA ok! 
#define prx_start_module_symbol				0x878D0 // IDA ok! 
#define prx_stop_module_symbol				0x88CA8 // IDA ok! 
#define prx_unload_module_symbol			0x87604 // IDA ok! 
#define prx_get_module_info_symbol			0x8708C // IDA ok! 
#define prx_get_module_id_by_address_symbol		0x86F9C // IDA ok! 
#define prx_get_module_id_by_name_symbol		0x86FEC // IDA ok! 
#define prx_get_module_list_symbol			0x8710C // IDA ok! 
#define load_module_by_fd_symbol			0x88234 // IDA ok! 
#define parse_sprx_symbol				0x85FB8 // IDA ok! 
#define open_prx_object_symbol				0x7F4F8 // IDA ok! 
#define close_prx_object_symbol				0x7FE08 // IDA ok! 
#define lock_prx_mutex_symbol				0x86F44 // IDA ok! 
#define unlock_prx_mutex_symbol				0x86F50 // IDA ok! 

#define extend_kstack_symbol				0x700A4 // IDA ok! 

#define get_pseudo_random_number_symbol		0x228180 // IDA ok! 
#define md5_reset_symbol			0x161E20 // IDA ok! 
#define md5_update_symbol			0x1628C0 // IDA ok! 
#define md5_final_symbol			0x162A40 // IDA ok! 
#define ss_get_open_psid_symbol			0x22A668 // IDA ok! 
#define update_mgr_read_eeprom_symbol		0x223A78 // IDA ok! 
#define update_mgr_write_eeprom_symbol		0x2239C0 // IDA ok! 

#define ss_params_get_update_status_symbol		0x50AB4 // IDA ok! 

#define syscall_table_symbol				0x363BE0 // IDA ok! 
#define syscall_call_offset				0x275C04 // IDA ok! 

#define read_bdvd0_symbol				0x1A461C // IDA ok! 
#define read_bdvd1_symbol				0x1A6248 // IDA ok! 
#define read_bdvd2_symbol				0x1B3400 // IDA ok! 
#define storage_internal_get_device_object_symbol	0x277EB4 // IDA ok! 

#define hid_mgr_read_usb_symbol			        0x102444 // IDA ok! 
#define hid_mgr_read_bt_symbol				0xFC31C // IDA ok! 

#define bt_set_controller_info_internal_symbol		0xF0388 // IDA ok! 

/* Calls, jumps */
#define device_event_port_send_call			0x28206C // IDA ok! 

#define ss_pid_call_1					0x21329C // IDA ok! 

#define process_map_caller_call				0x4D24 // IDA ok! 

#define read_module_header_call				0x7F3EC // IDA ok! 
#define read_module_body_call				0x671C // IDA ok! 
#define load_module_by_fd_call1				0x88AA0 // IDA ok! 

#define shutdown_copy_params_call			0xAACC // bytes matched: 0x18*  2F830000409E005C7FC6F3787FA3EB78388000017F65DB78

#define fsloop_open_call					0x297A98 // IDA ok! 
#define fsloop_close_call					0x297AE8 //  IDA ok! 
#define fsloop_read_call					0x297B28 //  IDA ok! 

/* Patches */
#define shutdown_patch_offset				0xAAB8 // IDA ok! 
#define module_sdk_version_patch_offset		0x26717C // IDA ok! 
#define module_add_parameter_to_parse_sprxpatch_offset	0x88310 // IDA ok! 

#define user_thread_prio_patch				0x203FC // IDA ok! 
#define user_thread_prio_patch2				0x20408 // IDA ok! 

#define lic_patch						0x56230 // IDA ok! 
#define ode_patch						0x2275F4 // IDA ok! 
...
/* Permissions */
#define permissions_func_symbol				0x3560 // IDA ok! 
#define permissions_exception1 				0x25100 // IDA ok! 
#define permissions_exception2				0xC3298 // IDA ok! 
#define permissions_exception3				0x204D0 // IDA ok! 

/* Legacy patches with no names yet */
/* Kernel offsets */
#define patch_data1_offset				0x3E2E40 // Under IDPS offset
#define patch_func2 					0x59D84 // IDA ok! 
#define patch_func2_offset 				0x2C 
#define patch_func8 					0x5640C // IDA ok! 
#define patch_func8_offset1 				0xA4 // IDA ok! 
#define patch_func8_offset2 				0x208 // IDA ok! 
#define patch_func9 					0x5A240 //IDA ok! 
#define patch_func9_offset 				0x4B8 // IDA ok! 
#define mem_base2						0x3D90 // IDA ok! 

/* vars */
#define thread_info_symbol				0x37DE30 // IDA ok! 
